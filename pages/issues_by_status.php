...
function tables ( $type ) {
    ...
    $data_table_print = "
        ...
        <tr class='tblheader'>
            ...
            <td class='dt-right nowrap'>" . lang_get( 'plugin_Statistics_total' ) . "</td>
        </tr>
        </thead>
 ";
...
if ( ON == $t_show_all ) {
?>
	<td><img src="plugin.php?page=Statistics/status-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=0&size=<?php echo $t_size ?> "></td>
<?php
}
?>
<td><img src="plugin.php?page=Statistics/status-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=1&size=<?php echo $t_size ?> "></td>
<td><img src="plugin.php?page=Statistics/status-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=2&size=<?php echo $t_size ?> "></td>
</tr>
</table>
