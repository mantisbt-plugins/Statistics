...
$data_table_print['open'] = "
    <table class='display' id='open' >
        ...
        <tr class='tblheader'>
            ...
            <td class='dt-right' nowrap>" . lang_get( 'plugin_Statistics_no_of_handlers' ) . "</td>
        </tr>
        </thead>
        <tbody>";
...
$summary_table_print = "
    ...
    <table class='display' id='summary' >
        ...
        <tbody>
            <tr>
                <td>" . lang_get( 'plugin_Statistics_average_handlers' ) . "&nbsp;</td>
                <td class='dt-right'>" . $avg['open'] . "&nbsp;</td>
                <td class='dt-right'>" . $avg['resolved'] . "&nbsp;</td>
                <td class='dt-right'>" . $avg['all_states'] . "</td>
            </tr>
            <tr>
                <td>" . lang_get( 'plugin_Statistics_never_assto_hnd' ) . "&nbsp;</td>
...
<script type='text/javascript' src="<?php echo plugin_page( 'csp_support&r=ibhan' ); ?>"></script>
...
<div id="wrapper">
        ...
        <div id="filter">
            ...
            <form method="get">
                <input type="hidden" name="page" value="Statistics/issues_by_handlers" />
            ...
            <div>
 					<a href="plugin.php?page=Statistics/dl_ibhandlers.php&start=<?php echo $start ?>&end=<?php echo $end ?>" class="btn" ><?php echo lang_get( 'plugin_Statistics_download' ); ?></a>
                </div>   
 </form>
        </div>
