...
foreach ( $result as $row ) {
    $data[$row['priority']][$row['status']] = $row['the_count'];
}
unset( $result );
...
//		break; 
	...
	$content .=  MantisEnum::getLabel( $resolution_enum_string, $key ) ;
	$content .= "|" ;
    foreach ( $status_values as $k => $v ) {
...
header("Content-Disposition: attachment; filename=Issues_By_Resolution.csv");
echo $content;
exit;
return;