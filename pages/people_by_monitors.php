...
function tables( $type ) {
    ...
    $data_table_print = "
        <thead>
        <tr class='tblheader'>
            <td width='100%'>" . lang_get( 'plugin_Statistics_monitor_name' ) . "</td>";
...
<script type='text/javascript' src="<?php echo plugin_page( 'csp_support&r=pbmon' ); ?>"></script>
...
<div id="wrapper">
        ...
        <div id="filter">
            ...
            <form method="get">
                <input type="hidden" name="page" value="Statistics/people_by_monitors" />
				...
				<div>
                    <input type="submit" id="displaysubmit" value=<?php echo lang_get( 'plugin_Statistics_display' ); ?> class="button" />
                        ...
                        <div>
 					&nbsp;&nbsp;&nbsp;<a href="plugin.php?page=Statistics/dl_pbmonitors.php&start=<?php echo $start ?>&end=<?php echo $end ?>" class="btn" ><?php echo lang_get( 'plugin_Statistics_download' ); ?></a>
                </div> 
			</form>
        </div>
