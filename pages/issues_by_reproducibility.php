...
<script type='text/javascript' src="<?php echo plugin_page( 'csp_support&r=ibrep' ); ?>"></script>
...
<div id="wrapper">
        ...
        <div id="filter">
            ...
            <form method="get">
                <input type="hidden" name="page" value="Statistics/issues_by_reproducibility" />
 ...
 <div>
             ...
             <div>
 					&nbsp;&nbsp;&nbsp;<a href="plugin.php?page=Statistics/dl_ibreproducibility.php&start=<?php echo $start ?>&end=<?php echo $end ?>" class="btn" ><?php echo lang_get( 'plugin_Statistics_download' ); ?></a>
                </div>  
 </form>
        </div>
...
if ( ON == $t_show_all ) {
?>
	<td><img src="plugin.php?page=Statistics/reproducibility-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=0&size=<?php echo $t_size ?>  "></td>
<?php
}
?>
<td><img src="plugin.php?page=Statistics/reproducibility-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=1&size=<?php echo $t_size ?>  "></td>
<td><img src="plugin.php?page=Statistics/reproducibility-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=2&size=<?php echo $t_size ?>  "></td>
</tr>
</table>
