...
<td><img src="plugin.php?page=Statistics/severity-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=0 "></td>
<td><img src="plugin.php?page=Statistics/severity-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=1 "></td>
<td><img src="plugin.php?page=Statistics/severity-graph.php&start=<?php echo $start ?>&end=<?php echo $end ?>&set=2 "></td>
</tr>
</table>
